...
class BlockchainConfig {
  ...
  async initialize() {
    try {
      // 1. Create provider
      // Use WebSocketProvider to fix "filter not found" errors on public load-balanced HTTP RPCs
      ...
      // Suppress any non-critical WebSocket disconnect errors
      this.provider.websocket.on("error", () => {});
